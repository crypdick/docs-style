...
* **Readability:**
  ...
  * Don't use "&" instead of "and" (unless in code/UI).
* **Headings:** Use a hierarchy (don't skip levels). Use descriptive headings.
* **Links:**
  * Use meaningful text (not "click here").
  * Explain unexpected behavior (e.g., "opens PDF").
