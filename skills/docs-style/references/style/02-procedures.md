...
* **Imperative verb:** Start with the action ("Click", "Enter").
* **Location first:** State where to act before the action ("In the console, click **Save**").
* **Goal first:** If the step has a specific goal, state it first ("To save changes, click **Save**").
* **Code and commands:** Focus on what the command does, not the act of running it.
