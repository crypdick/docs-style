...
# Editing documents inherently involves original/replacement text and prior decisions.
# Flag historical narration, not vocabulary describing the editing domain.
TEMPORAL_KEYWORDS = [
    r"\bused to\b",
    r"\bis now\b",
    r"\bfor now\b",
