...
* **Numbered list:** For sequential steps, priorities, or items where order matters.
* **Bulleted list:** For non-sequential items or options.
* **Description list:** For terms and definitions.
* **Run-in headings:** A bulleted list where each item starts with a bold term and a colon (e.g., **Term**: Description).
