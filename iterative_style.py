...
DIFF_SYSTEM_PROMPT = (
    ...
    "it must match the document text *character-for-character*, including all whitespace. "
    "If it is not an exact match, applying the diff will fail with an error.\n"
    "Thefore, it is not necessary to wrap the contents of <before> or <after> with quotation marks or other wrapping characters in order to match the source text."
